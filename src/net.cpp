...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Javacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"node1.javacoin.me", "209.105.248.111"},
    {"node2.javacoin.me", "145.239.74.230"},
    {"node3.javacoin.me", "91.92.136.165"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Javacoin is probably already running."), addrBind.ToString().c_str());
        else
