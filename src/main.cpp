...
uint256 hashGenesisBlock("0x746f76f5ec55d46119b3f1940b3518e323f708dc300636dfd8be3a66393a8841");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(520343692); // Javacoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Javacoin Signed Message:\n";
...
{
    // Javacoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight <= 840){
       nSubsidy = 100500000000000;
    }

    // Subsidy is cut in half every 8400000 blocks, which will occur approximately every 8 years
    nSubsidy >>= (nHeight / 8400000); // Javacoin: 8.4M blocks in ~8 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 129600; // Javacoin: 36 Hours
static const int64 nTargetSpacing = 30; // Javacoin: 30 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Javacoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Javacoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Javacoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x746f76f5ec55d46119b3f1940b3518e323f708dc300636dfd8be3a66393a8841");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Hope Sarajevo will have water";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 500000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("f2c346189d96a5725fe5c3c33b91664df0a68c02c557971003890e489754f1fd7fc2e8e2aec7c59803a3e58f3565e60a1e1ca217d122ec7c0a0cb5395ef5568d3d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1513279978;
        ...
        assert(block.hashMerkleRoot == uint256("0xc2205af3e50448cedd1c6c1d82a60322a8fa013e340a916ab9df91506e31473b"));
		//------------------------------------
/*
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // Javacoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("JavacoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("JavacoinMiner : ProcessBlock, block not accepted");
    }
