...
static const unsigned int MAX_BLOCK_SIZE = 32000000;                      // 32MB block hard limit
/** The maximum size for mined blocks */
static const unsigned int MAX_BLOCK_SIZE_GEN = 1000000;         // 1MB  block soft limit
/** The maximum size for transactions we're willing to relay/mine */
static const unsigned int MAX_STANDARD_TX_SIZE = 100000; // 100KB tx size limit
...
static const unsigned int BLOCKFILE_CHUNK_SIZE = 33554432; // 32 MiB
/** The pre-allocation chunk size for rev?????.dat files (since 0.8) */
static const unsigned int UNDOFILE_CHUNK_SIZE = 1048576; // 1 MiB
/** Fake height value used in CCoins to signify they are only in the memory pool (since 0.8) */
static const unsigned int MEMPOOL_HEIGHT = 0x7FFFFFFF;
/** Dust Soft Limit, allowed with additional fee per output */
static const int64 DUST_SOFT_LIMIT = 100000; // 0.01 JVC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 100000;   // 0.0001 JVC mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 8484000000000000000;
